...
<section>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6 bg-[#FFFBE9] p-6 rounded-xl border border-[#E3CAA5]">
        @csrf
        @method('put')

        <div>
            <x-input-label for="update_password_current_password" :value="__('Current Password')" class="text-[#AD8B73]" />
        ...
        <div>
            <x-input-label for="update_password_password" :value="__('New Password')" class="text-[#AD8B73]" />
        ...
        <div>
            <x-input-label for="update_password_password_confirmation" :value="__('Confirm Password')" class="text-[#AD8B73]" />
